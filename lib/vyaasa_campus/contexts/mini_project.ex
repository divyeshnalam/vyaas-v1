defmodule VyaasaCampus.AI.MiniProjectEngine do
  ...
  def evaluate(chosen_scenario, artifacts, discovery_messages, viva_turns, reflection) do
    VyaasaCampus.AI.Tracing.span("mini_project.evaluate", fn ->
      do_evaluate(chosen_scenario, artifacts, discovery_messages, viva_turns, reflection)
    end)
  end

  defp do_evaluate(chosen_scenario, artifacts, discovery_messages, viva_turns, reflection) do
